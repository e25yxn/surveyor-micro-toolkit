/**
 * ============================================================================
 *  AlignmentBuilder — สร้างตาราง element จากเส้นโครง PI (แนว B)   [v1.1]
 * ----------------------------------------------------------------------------
...
if (typeof module !== 'undefined' && module.exports) module.exports = AlignmentBuilder;
