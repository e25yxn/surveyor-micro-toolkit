Attribute VB_Name = "SMT_WCB"
Option Explicit

' ============================================================
' SMT_WCB.bas  --  VBA port of src/smt/wcb.py
' SMT (Surveyor Micro Toolkit) -- Azimuth / Coordinate Geometry
'
' Azimuth (WCB = Whole Circle Bearing):
'   0 = North, increases clockwise: East=pi/2, South=pi, West=3*pi/2
' Dependency: SMT_FPMath module must be imported in the same workbook.
' ============================================================
...
' ============================================================
' Public API -- 4 functions, all with SMT_ prefix
' ============================================================
